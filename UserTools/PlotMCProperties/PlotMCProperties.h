#ifndef PlotMCProperties_H
#define PlotMCProperties_H
...
class PlotMCProperties: public Tool {


 public:

  PlotMCProperties(); ///< Simple constructor
 ...
 private:
	...
	std::vector<double> *particleE_secondaries = nullptr;
	...
	std::vector<double> *secparticle_posX = nullptr;
	std::vector<double> *secparticle_posY = nullptr;
	std::vector<double> *secparticle_posZ = nullptr;
	std::vector<double> *secparticle_stopposX = nullptr;
	std::vector<double> *secparticle_stopposY = nullptr;
	std::vector<double> *secparticle_stopposZ = nullptr;
